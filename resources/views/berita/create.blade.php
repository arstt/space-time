        ...
        <div class="card-body">
            <form action="{{ route('beritas.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="beritaTitle" type="text" class="form-control" placeholder="Park Landscpar">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="beritaDescription" class="form-control" placeholder="Isi berita disini"></textarea>
                </div>
